...
const dataBinds = {
  id7: { 
    ...
    rules: function ($comp, lists, forItems, event) {const $for=forItems; return (
    ...
    validateStatus: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.validateStatus
    ); },
    validateTrigger: function ($comp, lists, forItems, event) {const $for=forItems; return (
  ...
  id9: { 
    ...
    size: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.size
    ); },
    type: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.type
    ); },
    focus: function ($comp, lists, forItems, event) {const $for=forItems; return (
    ...
    password: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.password
    ); },
    clearable: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.clearable
    ); },
    maxLength: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.maxLength
    ); },
    placeholder: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.placeholder
    ); },
    defaultValue: function ($comp, lists, forItems, event) {const $for=forItems; return (
