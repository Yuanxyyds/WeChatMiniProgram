...
const dataBinds = {
  id2: { 
    ...
    text: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.content
    ); },
    type: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.type
    ); },
    loading: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.loading
    ); },
    disabled: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.disabled
    ); },
    formType: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.formType
    ); },
    openType: function ($comp, lists, forItems, event) {const $for=forItems; return (
