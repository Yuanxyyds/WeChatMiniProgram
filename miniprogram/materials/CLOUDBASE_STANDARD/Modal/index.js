...
const dataBinds = {
  ...
  id24: { 
    content: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.content
    ); },
    visible: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.visible
    ); },
    isDefaultButton: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.props.data.isDefaultButton
    ); },
    _waIf: function ($comp, lists, forItems, event) {const $for=forItems; return (
      $comp.state._mode==='pc'
